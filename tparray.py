...
class TPArray():
    ...
    def _comp_vdd(self, df_meas):
        ...
        vdd = vdd * (vdd_av - vdd_th1 - ((vdd_th2 - vdd_th1) / (ptat_th2 - ptat_th1)) * (ptat_av - ptat_th1))
    ...
    def rawmeas_to_dK(self, df_meas):
        ...
        Warning(
            '''rawmeas_to_dK returns compensated voltage, not dK! Remaining operations need to be implemented for dataframe format!''')
